...
db.notes.insertMany([
  ...
  { "patId": 4, "patient": "TestEarlyOnset", "note": "Le patient déclare avoir commencé à fumer depuis peu. Hémoglobine A1C supérieure au niveau recommandé" },
  { "patId": 4, "patient": "TestEarlyOnset", "note": "Taille, Poids, Cholestérol, Vertige et Réaction" }
]);
